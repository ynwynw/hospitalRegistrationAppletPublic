  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   <div class="label">医生职称</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yishengzhicheng" class="input" type="text" placeholder="医生职称">
			   </div>
			 </div> -->
			<el-form-item label="医生职称" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.yishengzhicheng" autocomplete="off" placeholder="医生职称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
